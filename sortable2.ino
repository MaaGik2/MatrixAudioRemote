...
void setup() {
    ...
    // Charger la configuration mute
    uint8_t muteConfigByte = loadMuteConfig();
    ...
    // Mise à jour des LEDs de configuration Matrix avec la configuration chargée
    for(int i = 0; i < NUM_LEDS_MATRIXCONF; i++) {
